function F=makeLMTextonfilters(Sz,nOri)
...
%
% From
% http://www.robots.ox.ac.uk/~vgg/research/texclass/code/makeLMfilters.m
%
...
SUP=Sz;                 % Support of the largest filter (must be odd)
SCALEX=sqrt(2).^[1:3];  % Sigma_{x} for the oriented filters
NORIENT=nOri;              % Number of orientations
