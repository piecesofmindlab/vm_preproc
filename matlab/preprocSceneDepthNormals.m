...
% ML 2012.11.11
% Updated 2014.12.03
% NOTE: Now the output of this function essentially computes the fraction
% (scaled 0-1) of the 2D screen that is devoted to a particular depth and
% surface orientation. Both depth and surface orientation are binned, to
% allow the brain to tell us which bins are important. The granularity of
% those bins is up to the user.
...
% relative depth is scaled to 0-100)
nDepthDivs = 5;
