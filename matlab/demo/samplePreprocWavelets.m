...
h = randn(20,20);
% Create noise convolved with a particular size & orientation of a Gabor
% filter.
for ii=1:3000
...
params.std_step = 3.0; % separation between the adjacent wavelets in STD of Gaussian window
...
%% preprocess
[stim params] = preprocWavelets3d(stim, params); % Changed preprocWavelets to "preprocWavelets3d"
...
%% visualize
visopt.show_bests = 1;
preprocWavelets3dVis(strf, visopt);
